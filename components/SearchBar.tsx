      ...
      <div className="flex gap-2">
        ...
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="relative w-full px-6 py-4 search-parchment placeholder-stone-500 font-serif text-base focus:outline-none focus:ring-2 focus:ring-amber-500/50 rounded-lg"
          />
        ...
        <button
          type="submit"
          className="search-button px-6 py-3 font-display font-semibold hover:scale-105 active:scale-95 transition-transform"
        >
          Search
        </button>
      </div>
